...
public class RainbowKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        throw new InvalidKeySpecException("Unsupported key specification: " + keySpec.getClass() + DownloadsManager.EXTENSION_SEPARATOR);
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        throw new InvalidKeySpecException("Unknown key specification: " + keySpec + DownloadsManager.EXTENSION_SEPARATOR);
    }
    ...
    public final KeySpec engineGetKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        if (key instanceof BCRainbowPrivateKey) {
            ...
            throw new InvalidKeySpecException("Unsupported key type: " + key.getClass() + DownloadsManager.EXTENSION_SEPARATOR);
        }
        throw new InvalidKeySpecException("Unknown key specification: " + cls + DownloadsManager.EXTENSION_SEPARATOR);
    }
