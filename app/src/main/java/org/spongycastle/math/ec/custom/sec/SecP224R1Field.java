...
public class SecP224R1Field {
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j6 = (iArr[8] & M) + j3;
        long j7 = (iArr[9] & M) + j4;
        long j8 = ((iArr[0] & M) - j5) + 0;
        long j9 = j8 & M;
        long j10 = (j8 >> 32) + ((iArr[1] & M) - j6);
        iArr2[1] = (int) j10;
        long j11 = (j10 >> 32) + ((iArr[2] & M) - j7);
        iArr2[2] = (int) j11;
        long j12 = (j11 >> 32) + (((iArr[3] & M) + j5) - j);
        long j13 = j12 & M;
        long j14 = (j12 >> 32) + (((iArr[4] & M) + j6) - j2);
        iArr2[4] = (int) j14;
        long j15 = (j14 >> 32) + (((iArr[5] & M) + j7) - j3);
        iArr2[5] = (int) j15;
        long j16 = (j15 >> 32) + (((iArr[6] & M) + j) - j4);
        iArr2[6] = (int) j16;
        long j17 = (j16 >> 32) + 1;
        long j18 = j13 + j17;
        long j19 = j9 - j17;
        ...
        long j20 = j19 >> 32;
        if (j20 != 0) {
            long j21 = j20 + (iArr2[1] & M);
            iArr2[1] = (int) j21;
            long j22 = (j21 >> 32) + (M & iArr2[2]);
            iArr2[2] = (int) j22;
            j18 += j22 >> 32;
        }
        iArr2[3] = (int) j18;
