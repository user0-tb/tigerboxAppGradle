    ...
    public static class Fp extends AbstractFp {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            if (coordinateSystem == 0) {
                ECFieldElement subtract = eCFieldElement6.subtract(eCFieldElement4);
                ECFieldElement subtract2 = eCFieldElement7.subtract(eCFieldElement5);
                if (subtract.isZero()) {
                    if (subtract2.isZero()) {
                        return twice();
                    }
                ...
                ECFieldElement subtract3 = divide.square().subtract(eCFieldElement4).subtract(eCFieldElement6);
                return new Fp(curve, subtract3, divide.multiply(eCFieldElement4.subtract(subtract3)).subtract(eCFieldElement5), this.withCompression);
                ...
                if (!isOne2) {
                    eCFieldElement5 = eCFieldElement5.multiply(eCFieldElement9);
                }
                ...
                ECFieldElement subtract5 = eCFieldElement6.subtract(eCFieldElement4);
                if (subtract5.isZero()) {
                    if (subtract4.isZero()) {
                        return twice();
                    }
                ...
                ECFieldElement multiply3 = square.multiply(eCFieldElement4);
                ECFieldElement subtract6 = subtract4.square().multiply(eCFieldElement8).subtract(multiply2).subtract(two(multiply3));
                return new Fp(curve, subtract5.multiply(subtract6), multiply3.subtract(subtract6).multiplyMinusProduct(subtract4, eCFieldElement5, multiply2), new ECFieldElement[]{multiply2.multiply(eCFieldElement8)}, this.withCompression);
                ...
                if (!isOne3 && eCFieldElement10.equals(eCFieldElement11)) {
                    multiply = eCFieldElement4.subtract(eCFieldElement6);
                    ...
                    ECFieldElement multiply4 = eCFieldElement4.multiply(square2);
                    ECFieldElement multiply5 = eCFieldElement6.multiply(square2);
                    ECFieldElement multiply6 = multiply4.subtract(multiply5).multiply(eCFieldElement5);
                    ECFieldElement subtract8 = subtract7.square().subtract(multiply4).subtract(multiply5);
                    ECFieldElement subtract9 = multiply4.subtract(subtract8).multiply(subtract7).subtract(multiply6);
                    if (isOne3) {
                        eCFieldElement3 = square2;
                    } else {
                        multiply = multiply.multiply(eCFieldElement10);
                        eCFieldElement3 = null;
                    }
                    eCFieldElement = subtract9;
                    eCFieldElement2 = subtract8;
                } else {
                    if (!isOne3) {
                        ECFieldElement square3 = eCFieldElement10.square();
                        eCFieldElement6 = square3.multiply(eCFieldElement6);
                        eCFieldElement7 = square3.multiply(eCFieldElement10).multiply(eCFieldElement7);
                    }
                    boolean isOne4 = eCFieldElement11.isOne();
                    if (!isOne4) {
                        ECFieldElement square4 = eCFieldElement11.square();
                        eCFieldElement4 = square4.multiply(eCFieldElement4);
                        eCFieldElement5 = square4.multiply(eCFieldElement11).multiply(eCFieldElement5);
                    }
                    ECFieldElement subtract10 = eCFieldElement4.subtract(eCFieldElement6);
                    ECFieldElement subtract11 = eCFieldElement5.subtract(eCFieldElement7);
                    ...
                    ECFieldElement multiply7 = square5.multiply(subtract10);
                    ECFieldElement multiply8 = square5.multiply(eCFieldElement4);
                    ECFieldElement subtract12 = subtract11.square().add(multiply7).subtract(two(multiply8));
                    ECFieldElement multiplyMinusProduct = multiply8.subtract(subtract12).multiplyMinusProduct(subtract11, multiply7, eCFieldElement5);
                    ECFieldElement multiply9 = !isOne3 ? subtract10.multiply(eCFieldElement10) : subtract10;
                    multiply = !isOne4 ? multiply9.multiply(eCFieldElement11) : multiply9;
                    eCFieldElement = multiplyMinusProduct;
                    eCFieldElement2 = subtract12;
                    eCFieldElement3 = multiply == subtract10 ? square5 : null;
                }
                return new Fp(curve, eCFieldElement2, eCFieldElement, coordinateSystem == 4 ? new ECFieldElement[]{multiply, calculateJacobianModifiedW(multiply, eCFieldElement3)} : new ECFieldElement[]{multiply}, this.withCompression);
            } else {
                throw new IllegalStateException("unsupported coordinate system");
            }
        }
