...
public interface PKCSObjectIdentifiers {
    ...
    static {
        ...
        pkcs_9_at_emailAddress = aSN1ObjectIdentifier6.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        pkcs_9_at_unstructuredName = aSN1ObjectIdentifier6.branch(ExifInterface.GPS_MEASUREMENT_2D);
        ...
        ASN1ObjectIdentifier branch = aSN1ObjectIdentifier6.branch("16");
        id_smime = branch;
        ...
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier6.branch("22");
        certTypes = branch2;
        x509Certificate = branch2.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        sdsiCertificate = branch2.branch(ExifInterface.GPS_MEASUREMENT_2D);
        ASN1ObjectIdentifier branch3 = aSN1ObjectIdentifier6.branch("23");
        crlTypes = branch3;
        x509Crl = branch3.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        ...
        ASN1ObjectIdentifier branch4 = branch.branch(ExifInterface.GPS_MEASUREMENT_3D);
        id_alg = branch4;
        ...
        ASN1ObjectIdentifier branch5 = aSN1ObjectIdentifier9.branch("15");
        id_aa_ets_sigPolicyId = branch5;
        ASN1ObjectIdentifier branch6 = aSN1ObjectIdentifier9.branch("16");
        id_aa_ets_commitmentType = branch6;
        ASN1ObjectIdentifier branch7 = aSN1ObjectIdentifier9.branch("17");
        id_aa_ets_signerLocation = branch7;
        id_aa_ets_signerAttr = aSN1ObjectIdentifier9.branch("18");
        ASN1ObjectIdentifier branch8 = aSN1ObjectIdentifier9.branch("19");
        id_aa_ets_otherSigCert = branch8;
        ...
        id_aa_sigPolicyId = branch5;
        id_aa_commitmentType = branch6;
        id_aa_signerLocation = branch7;
        id_aa_otherSigCert = branch8;
        ...
        ASN1ObjectIdentifier branch9 = aSN1ObjectIdentifier10.branch("10.1");
        bagtypes = branch9;
        keyBag = branch9.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        pkcs8ShroudedKeyBag = branch9.branch(ExifInterface.GPS_MEASUREMENT_2D);
        certBag = branch9.branch(ExifInterface.GPS_MEASUREMENT_3D);
        crlBag = branch9.branch("4");
        secretBag = branch9.branch("5");
        safeContentsBag = branch9.branch("6");
        ASN1ObjectIdentifier branch10 = aSN1ObjectIdentifier10.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        pkcs_12PbeIds = branch10;
        pbeWithSHAAnd128BitRC4 = branch10.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
        pbeWithSHAAnd40BitRC4 = branch10.branch(ExifInterface.GPS_MEASUREMENT_2D);
        pbeWithSHAAnd3_KeyTripleDES_CBC = branch10.branch(ExifInterface.GPS_MEASUREMENT_3D);
        pbeWithSHAAnd2_KeyTripleDES_CBC = branch10.branch("4");
        pbeWithSHAAnd128BitRC2_CBC = branch10.branch("5");
        pbeWithSHAAnd40BitRC2_CBC = branch10.branch("6");
        pbewithSHAAnd40BitRC2_CBC = branch10.branch("6");
