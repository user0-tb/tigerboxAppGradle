...
public final class AesFlushingCipher {
    ...
    public AesFlushingCipher(int i, byte[] bArr, long j, long j2) {
        try {
            ...
            cipher.init(i, new SecretKeySpec(bArr, Util.splitAtFirst(cipher.getAlgorithm(), DownloadsManager.FOLDERS_SEPARATOR)[0]), new IvParameterSpec(getInitializationVector(j, j2 / blockSize)));
            if (i2 != 0) {
