...
public interface DrmSessionEventListener {
    ...
    public static class EventDispatcher {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: com.google.android.exoplayer2.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda4
                    ...
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m131x7aff32be(drmSessionEventListener, i);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void m131x7aff32be(DrmSessionEventListener drmSessionEventListener, int i) {
        ...
        public void drmKeysLoaded() {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: com.google.android.exoplayer2.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m128x6262ec98(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void m128x6262ec98(DrmSessionEventListener drmSessionEventListener) {
        ...
        public void drmSessionManagerError(final Exception exc) {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: com.google.android.exoplayer2.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m132x99ee26cd(drmSessionEventListener, exc);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void m132x99ee26cd(DrmSessionEventListener drmSessionEventListener, Exception exc) {
        ...
        public void drmKeysRestored() {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: com.google.android.exoplayer2.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m130x8910d2ab(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void m130x8910d2ab(DrmSessionEventListener drmSessionEventListener) {
        ...
        public void drmKeysRemoved() {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: com.google.android.exoplayer2.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m129xc24f0d8a(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void m129xc24f0d8a(DrmSessionEventListener drmSessionEventListener) {
        ...
        public void drmSessionReleased() {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: com.google.android.exoplayer2.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m133xbad440f2(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void m133xbad440f2(DrmSessionEventListener drmSessionEventListener) {
