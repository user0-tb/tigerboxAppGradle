...
public interface SendChannel<E> {
    ...
    Object mo1736trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1736trySendJP2dKIU = sendChannel.mo1736trySendJP2dKIU(e);
            if (ChannelResult.m1751isSuccessimpl(mo1736trySendJP2dKIU)) {
                return true;
            }
            Throwable m1745exceptionOrNullimpl = ChannelResult.m1745exceptionOrNullimpl(mo1736trySendJP2dKIU);
