...
public interface ReceiveChannel<E> {
    ...
    Object mo1734receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1735tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1735tryReceivePtdJZtk = receiveChannel.mo1735tryReceivePtdJZtk();
            if (ChannelResult.m1751isSuccessimpl(mo1735tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1747getOrThrowimpl(mo1735tryReceivePtdJZtk);
            }
            Throwable m1745exceptionOrNullimpl = ChannelResult.m1745exceptionOrNullimpl(mo1735tryReceivePtdJZtk);
            if (m1745exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1745exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L19:
                ...
                java.lang.Object r4 = r5.m1753unboximpl()
                goto L44
            L30:
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo1734receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m1746getOrNullimpl(r4)
                return r4
            */
