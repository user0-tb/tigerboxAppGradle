...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1757invokeWpGqRn0(((ChannelResult) obj).m1753unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1757invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1741boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object m1753unboximpl = ((ChannelResult) this.L$0).m1753unboximpl();
            Throwable m1745exceptionOrNullimpl = ChannelResult.m1745exceptionOrNullimpl(m1753unboximpl);
            if (m1745exceptionOrNullimpl != null) {
                throw m1745exceptionOrNullimpl;
            }
            Object m1746getOrNullimpl = ChannelResult.m1746getOrNullimpl(m1753unboximpl);
            this.label = 1;
            obj = this.$block.invoke(m1746getOrNullimpl, this);
