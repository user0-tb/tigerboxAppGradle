...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public void mo1783scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
    ...
    */
    public long processNextEvent() {
        ...
        L24:
            ...
            monitor-enter(r5)
            kotlinx.coroutines.internal.ThreadSafeHeapNode r6 = r5.firstImpl()     // Catch: java.lang.Throwable -> L52
            r7 = 0
            if (r6 != 0) goto L31
            monitor-exit(r5)
            goto L4d
        L31:
            kotlinx.coroutines.EventLoopImplBase$DelayedTask r6 = (kotlinx.coroutines.EventLoopImplBase.DelayedTask) r6     // Catch: java.lang.Throwable -> L52
            boolean r8 = r6.timeToExecute(r3)     // Catch: java.lang.Throwable -> L52
            r9 = 0
            if (r8 == 0) goto L41
            java.lang.Runnable r6 = (java.lang.Runnable) r6     // Catch: java.lang.Throwable -> L52
            boolean r6 = r10.enqueueImpl(r6)     // Catch: java.lang.Throwable -> L52
            goto L42
        L41:
            r6 = 0
        L42:
            if (r6 == 0) goto L4a
            kotlinx.coroutines.internal.ThreadSafeHeapNode r6 = r5.removeAtImpl(r9)     // Catch: java.lang.Throwable -> L52
            r7 = r6
            goto L4c
        L4a:
            kotlinx.coroutines.internal.ThreadSafeHeapNode r7 = (kotlinx.coroutines.internal.ThreadSafeHeapNode) r7     // Catch: java.lang.Throwable -> L52
        L4c:
            monitor-exit(r5)
        L4d:
    ...
    public final void mo1782dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        enqueue(runnable);
    }
