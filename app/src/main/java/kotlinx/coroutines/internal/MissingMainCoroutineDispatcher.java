...
public final class MissingMainCoroutineDispatcher extends MainCoroutineDispatcher implements Delay {
    ...
    public /* bridge */ /* synthetic */ void mo1783scheduleResumeAfterDelay(long j, CancellableContinuation cancellableContinuation) {
    ...
    public Void mo1782dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        missing();
        throw new KotlinNothingValueException();
    }
