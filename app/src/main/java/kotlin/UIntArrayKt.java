...
public final class UIntArrayKt {
    ...
    private static final int[] m403uintArrayOfajY9A(int... elements) {
    ...
    private static final int[] UIntArray(int i, Function1<? super Integer, UInt> init) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            iArr[i2] = init.invoke(Integer.valueOf(i2)).m384unboximpl();
        }
        return UIntArray.m387constructorimpl(iArr);
    }
}
