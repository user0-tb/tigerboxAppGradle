...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker, j$.util.Iterator {
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m333constructorimpl(i3);
        this.next = this.hasNext ? i : i2;
    }

    @Override // java.util.Iterator, j$.util.Iterator
    public /* bridge */ /* synthetic */ Object next() {
        return UInt.m327boximpl(m1471nextpVg5ArA());
    }
    ...
    public int m1471nextpVg5ArA() {
        ...
        if (i == this.finalElement) {
            ...
            this.next = UInt.m333constructorimpl(this.step + i);
        }
        return i;
    }
}
