...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker, j$.util.Iterator {
    ...
    private ULongProgressionIterator(long j, long j2, long j3) {
        ...
        this.hasNext = z;
        this.step = ULong.m411constructorimpl(j3);
        this.next = this.hasNext ? j : j2;
    }

    @Override // java.util.Iterator, j$.util.Iterator
    public /* bridge */ /* synthetic */ Object next() {
        return ULong.m405boximpl(m1480nextsVKNKU());
    }
    ...
    public long m1480nextsVKNKU() {
        ...
        if (j == this.finalElement) {
            ...
            this.next = ULong.m411constructorimpl(this.step + j);
        }
        return j;
    }
}
