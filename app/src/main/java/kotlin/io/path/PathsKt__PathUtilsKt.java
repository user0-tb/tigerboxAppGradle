...
class PathsKt__PathUtilsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final String getNameWithoutExtension(Path path) {
        ...
        Intrinsics.checkNotNullParameter(path, "<this>");
        Path fileName = path.getFileName();
        return (fileName == null || (obj = fileName.toString()) == null || (substringBeforeLast$default = StringsKt.substringBeforeLast$default(obj, DownloadsManager.EXTENSION_SEPARATOR, (String) null, 2, (Object) null)) == null) ? "" : substringBeforeLast$default;
    }
    ...
    public static final String getInvariantSeparatorsPathString(Path path) {
        ...
        if (Intrinsics.areEqual(separator, DownloadsManager.FOLDERS_SEPARATOR)) {
            return path.toString();
        }
        String obj = path.toString();
        Intrinsics.checkNotNullExpressionValue(separator, "separator");
        return StringsKt.replace$default(obj, separator, DownloadsManager.FOLDERS_SEPARATOR, false, 4, (Object) null);
    }
