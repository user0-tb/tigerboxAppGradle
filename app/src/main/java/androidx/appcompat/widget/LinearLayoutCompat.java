...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<LinearLayoutCompat> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mOrientationId = propertyMapper.mapIntEnum("orientation", 16842948, C$r8$wrapper$java$util$function$IntFunction$WRP.convert(new IntFunction<String>() { // from class: androidx.appcompat.widget.LinearLayoutCompat.InspectionCompanion.1
            ...
            this.mShowDividersId = propertyMapper.mapIntFlag("showDividers", R.attr.showDividers, C$r8$wrapper$java$util$function$IntFunction$WRP.convert(new IntFunction<Set<String>>() { // from class: androidx.appcompat.widget.LinearLayoutCompat.InspectionCompanion.2
                @Override // j$.util.function.IntFunction
