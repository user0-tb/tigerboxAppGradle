...
public class ExifInterface {
    ...
    public static class Rational {
        ...
        public String toString() {
            return this.numerator + DownloadsManager.FOLDERS_SEPARATOR + this.denominator;
        }
                    ...
                    switch (i) {
                        ...
                        case 5:
                            ...
                            while (i8 < split3.length) {
                                String[] split4 = split3[i8].split(DownloadsManager.FOLDERS_SEPARATOR, i5);
                        ...
                        case 10:
                            ...
                            while (i10 < split6.length) {
                                String[] split7 = split6[i10].split(DownloadsManager.FOLDERS_SEPARATOR, -1);
    ...
    */
    ...
    private static double convertRationalLatLonToDouble(String str, String str2) {
        try {
            ...
            String[] split2 = split[0].split(DownloadsManager.FOLDERS_SEPARATOR, -1);
            String[] split3 = split[1].split(DownloadsManager.FOLDERS_SEPARATOR, -1);
            String[] split4 = split[2].split(DownloadsManager.FOLDERS_SEPARATOR, -1);
    ...
    */
    ...
    private static Pair<Integer, Integer> guessDataFormat(String str) {
        if (str.contains(",")) {
            ...
            return guessDataFormat;
        } else if (str.contains(DownloadsManager.FOLDERS_SEPARATOR)) {
            String[] split2 = str.split(DownloadsManager.FOLDERS_SEPARATOR, -1);
            if (split2.length == 2) {
                try {
