    ...
    public static class Destination extends NavDestination {
        ...
        public boolean equals(Object obj) {
            if (obj != null && (obj instanceof Destination) && super.equals(obj)) {
                Intent intent = this.intent;
                Boolean valueOf = intent == null ? null : Boolean.valueOf(intent.filterEquals(((Destination) obj).intent));
                return (valueOf == null ? ((Destination) obj).intent == null : valueOf.booleanValue()) && Intrinsics.areEqual(this.dataPattern, ((Destination) obj).dataPattern);
            }
            return false;
        }
