...
public final class EmbeddingAdapter {
    ...
    public final Predicate<Pair<Activity, Activity>> translateActivityPairPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda1
            ...
            public final boolean test(Object obj) {
                boolean m74translateActivityPairPredicates$lambda1;
                m74translateActivityPairPredicates$lambda1 = EmbeddingAdapter.m74translateActivityPairPredicates$lambda1(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m74translateActivityPairPredicates$lambda1;
            }
        };
    }
    ...
    public static final boolean m74translateActivityPairPredicates$lambda1(EmbeddingAdapter this$0, Set splitPairFilters, Pair pair) {
    ...
    public final Predicate<Pair<Activity, Intent>> translateActivityIntentPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda0
            ...
            @Override // j$.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m73translateActivityIntentPredicates$lambda3;
                m73translateActivityIntentPredicates$lambda3 = EmbeddingAdapter.m73translateActivityIntentPredicates$lambda3(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m73translateActivityIntentPredicates$lambda3;
            }
        };
    }
    ...
    public static final boolean m73translateActivityIntentPredicates$lambda3(EmbeddingAdapter this$0, Set splitPairFilters, Pair pair) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(splitPairFilters, "$splitPairFilters");
        Intrinsics.checkNotNullExpressionValue(pair, "(first, second)");
        Activity activity = (Activity) this$0.component1(pair);
    ...
    public final Predicate<WindowMetrics> translateParentMetricsPredicate(final SplitRule splitRule) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda2
            ...
            @Override // j$.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m77translateParentMetricsPredicate$lambda4;
                m77translateParentMetricsPredicate$lambda4 = EmbeddingAdapter.m77translateParentMetricsPredicate$lambda4(SplitRule.this, (WindowMetrics) obj);
                return m77translateParentMetricsPredicate$lambda4;
            }
        };
    }
    ...
    public static final boolean m77translateParentMetricsPredicate$lambda4(SplitRule splitRule, WindowMetrics windowMetrics) {
        Intrinsics.checkNotNullParameter(splitRule, "$splitRule");
    ...
    public final Predicate<Activity> translateActivityPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda3
            ...
            @Override // j$.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m75translateActivityPredicates$lambda6;
                m75translateActivityPredicates$lambda6 = EmbeddingAdapter.m75translateActivityPredicates$lambda6(activityFilters, (Activity) obj);
                return m75translateActivityPredicates$lambda6;
            }
        };
    }
    ...
    public static final boolean m75translateActivityPredicates$lambda6(Set activityFilters, Activity activity) {
        Intrinsics.checkNotNullParameter(activityFilters, "$activityFilters");
    ...
    public final Predicate<Intent> translateIntentPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda4
            ...
            @Override // j$.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m76translateIntentPredicates$lambda8;
                m76translateIntentPredicates$lambda8 = EmbeddingAdapter.m76translateIntentPredicates$lambda8(activityFilters, (Intent) obj);
                return m76translateIntentPredicates$lambda8;
            }
        };
    }
    ...
    public static final boolean m76translateIntentPredicates$lambda8(Set activityFilters, Intent intent) {
        Intrinsics.checkNotNullParameter(activityFilters, "$activityFilters");
        Set<ActivityFilter> set = activityFilters;
        if ((set instanceof Collection) && set.isEmpty()) {
            return false;
