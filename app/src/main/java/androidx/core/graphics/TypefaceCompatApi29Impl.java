        ...
        try {
            ...
            while (true) {
                ...
                if (i2 >= length) {
                    ...
                    return new Typeface.CustomFallbackBuilder(builder.build()).setStyle(new FontStyle((i & 1) != 0 ? TypedValues.TransitionType.TYPE_DURATION : HttpStatusCodesKt.HTTP_BAD_REQUEST, (i & 2) != 0 ? 1 : 0)).build();
                }
