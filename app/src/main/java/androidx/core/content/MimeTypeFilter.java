...
public final class MimeTypeFilter {
    ...
    public static boolean matches(String str, String str2) {
        ...
        return mimeTypeAgainstFilter(str.split(DownloadsManager.FOLDERS_SEPARATOR), str2.split(DownloadsManager.FOLDERS_SEPARATOR));
    }
    ...
    public static String matches(String str, String[] strArr) {
        ...
        String[] split = str.split(DownloadsManager.FOLDERS_SEPARATOR);
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(split, str2.split(DownloadsManager.FOLDERS_SEPARATOR))) {
                return str2;
            }
        }
        return null;
    ...
    public static String matches(String[] strArr, String str) {
        ...
        String[] split = str.split(DownloadsManager.FOLDERS_SEPARATOR);
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(str2.split(DownloadsManager.FOLDERS_SEPARATOR), split)) {
                return str2;
            }
        }
        return null;
