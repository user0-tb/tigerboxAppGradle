        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    arrayList2.add(FontsContractCompat.FontInfo.create(withAppendedId, i3, columnIndex5 != -1 ? cursor.getInt(columnIndex5) : HttpStatusCodesKt.HTTP_BAD_REQUEST, columnIndex6 != -1 && cursor.getInt(columnIndex6) == 1, i));
                }
