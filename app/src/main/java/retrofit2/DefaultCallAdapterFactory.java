...
public final class DefaultCallAdapterFactory extends CallAdapter.Factory {
    ...
    public static final class ExecutorCallbackCall<T> implements Call<T> {
        ...
        public class AnonymousClass1 implements Callback<T> {
            ...
            public void onResponse(Call<T> call, final Response<T> response) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.DefaultCallAdapterFactory$ExecutorCallbackCall$1$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        DefaultCallAdapterFactory.ExecutorCallbackCall.AnonymousClass1.this.m2221xddacc936(callback, response);
                    }
                });
            }

            /* renamed from: lambda$onResponse$0$retrofit2-DefaultCallAdapterFactory$ExecutorCallbackCall$1  reason: not valid java name */
            public /* synthetic */ void m2221xddacc936(Callback callback, Response response) {
            ...
            public /* synthetic */ void m2220x714e864(Callback callback, Throwable th) {
            ...
            public void onFailure(Call<T> call, final Throwable th) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.DefaultCallAdapterFactory$ExecutorCallbackCall$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        DefaultCallAdapterFactory.ExecutorCallbackCall.AnonymousClass1.this.m2220x714e864(callback, th);
                    }
                });
            }
        }
        ...
        @Override // retrofit2.Call
        public Call<T> clone() {
            return new ExecutorCallbackCall(this.callbackExecutor, this.delegate.mo2219clone());
        }
