...
public final class ParentalGateDisableStepFragment extends Hilt_ParentalGateDisableStepFragment {
    ...
    public ParentalGateDisableStepFragment() {
        final ParentalGateDisableStepFragment parentalGateDisableStepFragment = this;
        this.binding$delegate = AutoClearedValueKt.autoCleared(parentalGateDisableStepFragment);
        final Function0<Fragment> function0 = new Function0<Fragment>() { // from class: media.tiger.tigerbox.ui.settings.parentalGate.ParentalGateDisableStepFragment$special$$inlined$viewModels$default$1
            {
                super(0);
            }
        ...
        this.viewModel$delegate = FragmentViewModelLazyKt.createViewModelLazy(parentalGateDisableStepFragment, Reflection.getOrCreateKotlinClass(ParentalGateEnableDisableStepViewModel.class), new Function0<ViewModelStore>() { // from class: media.tiger.tigerbox.ui.settings.parentalGate.ParentalGateDisableStepFragment$special$$inlined$viewModels$default$2
            {
                super(0);
            }
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: media.tiger.tigerbox.ui.settings.parentalGate.ParentalGateDisableStepFragment$special$$inlined$viewModels$default$3
            ...
            public final ViewModelProvider.Factory invoke() {
                ...
                if (defaultViewModelProviderFactory == null) {
                    defaultViewModelProviderFactory = parentalGateDisableStepFragment.getDefaultViewModelProviderFactory();
                }
    ...
    private final FragmentParentalGateDisableStepBinding getBinding() {
        return (FragmentParentalGateDisableStepBinding) this.binding$delegate.getValue((Fragment) this, $$delegatedProperties[0]);
    }

    private final void setBinding(FragmentParentalGateDisableStepBinding fragmentParentalGateDisableStepBinding) {
        this.binding$delegate.setValue2((Fragment) this, $$delegatedProperties[0], (KProperty<?>) fragmentParentalGateDisableStepBinding);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        FragmentParentalGateDisableStepBinding inflate = FragmentParentalGateDisableStepBinding.inflate(inflater, viewGroup, false);
        Intrinsics.checkNotNullExpressionValue(inflate, "inflate(inflater, container, false)");
        setBinding(inflate);
        getBinding().fragmentParentalGateDisableStepOkButton.setOnClickListener(new View.OnClickListener() { // from class: media.tiger.tigerbox.ui.settings.parentalGate.ParentalGateDisableStepFragment$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ParentalGateDisableStepFragment.m1997onCreateView$lambda0(ParentalGateDisableStepFragment.this, view);
            }
        });
        getBinding().fragmentParentalGateDisableStepCancelButton.setOnClickListener(new View.OnClickListener() { // from class: media.tiger.tigerbox.ui.settings.parentalGate.ParentalGateDisableStepFragment$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ParentalGateDisableStepFragment.m1998onCreateView$lambda1(ParentalGateDisableStepFragment.this, view);
            }
        });
    ...
    public static final void m1997onCreateView$lambda0(ParentalGateDisableStepFragment this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.getViewModel().setParentalGateState(false);
        this$0.closeSafely();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: onCreateView$lambda-1  reason: not valid java name */
    public static final void m1998onCreateView$lambda1(ParentalGateDisableStepFragment this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.closeSafely();
    }
