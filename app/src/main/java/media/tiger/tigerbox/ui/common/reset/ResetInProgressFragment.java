...
public final class ResetInProgressFragment extends Hilt_ResetInProgressFragment {
    ...
    public ResetInProgressFragment() {
        final ResetInProgressFragment resetInProgressFragment = this;
        this.binding$delegate = AutoClearedValueKt.autoCleared(resetInProgressFragment);
        final Function0<Fragment> function0 = new Function0<Fragment>() { // from class: media.tiger.tigerbox.ui.common.reset.ResetInProgressFragment$special$$inlined$viewModels$default$1
            {
                super(0);
            }
        ...
        this.viewModel$delegate = FragmentViewModelLazyKt.createViewModelLazy(resetInProgressFragment, Reflection.getOrCreateKotlinClass(ResetInProgressViewModel.class), new Function0<ViewModelStore>() { // from class: media.tiger.tigerbox.ui.common.reset.ResetInProgressFragment$special$$inlined$viewModels$default$2
            {
                super(0);
            }
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: media.tiger.tigerbox.ui.common.reset.ResetInProgressFragment$special$$inlined$viewModels$default$3
            ...
            public final ViewModelProvider.Factory invoke() {
                ...
                if (defaultViewModelProviderFactory == null) {
                    defaultViewModelProviderFactory = resetInProgressFragment.getDefaultViewModelProviderFactory();
                }
    ...
    private final FragmentResetInProgressBinding getBinding() {
        return (FragmentResetInProgressBinding) this.binding$delegate.getValue((Fragment) this, $$delegatedProperties[0]);
    }

    private final void setBinding(FragmentResetInProgressBinding fragmentResetInProgressBinding) {
        this.binding$delegate.setValue2((Fragment) this, $$delegatedProperties[0], (KProperty<?>) fragmentResetInProgressBinding);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        FragmentResetInProgressBinding inflate = FragmentResetInProgressBinding.inflate(inflater, viewGroup, false);
