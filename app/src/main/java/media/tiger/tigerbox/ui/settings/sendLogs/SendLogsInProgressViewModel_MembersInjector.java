...
public final class SendLogsInProgressViewModel_MembersInjector implements MembersInjector<SendLogsInProgressViewModel> {
    ...
    public SendLogsInProgressViewModel_MembersInjector(Provider<LightControlService> _lightControlProvider) {
        this._lightControlProvider = _lightControlProvider;
    }

    public static MembersInjector<SendLogsInProgressViewModel> create(Provider<LightControlService> _lightControlProvider) {
        return new SendLogsInProgressViewModel_MembersInjector(_lightControlProvider);
    }

    @Override // dagger.MembersInjector
    public void injectMembers(SendLogsInProgressViewModel instance) {
