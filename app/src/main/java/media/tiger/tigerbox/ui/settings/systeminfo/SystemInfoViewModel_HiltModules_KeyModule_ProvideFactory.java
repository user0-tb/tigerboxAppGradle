...
import media.tiger.tigerbox.ui.settings.systeminfo.SystemInfoViewModel_HiltModules;
...
public final class SystemInfoViewModel_HiltModules_KeyModule_ProvideFactory implements Factory<String> {
    ...
    private static final class InstanceHolder {
        private static final SystemInfoViewModel_HiltModules_KeyModule_ProvideFactory INSTANCE = new SystemInfoViewModel_HiltModules_KeyModule_ProvideFactory();
