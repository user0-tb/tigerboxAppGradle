...
import media.tiger.tigerbox.ui.settings.sendLogs.SendLogsFinishedViewModel_HiltModules;
...
public final class SendLogsFinishedViewModel_HiltModules_KeyModule_ProvideFactory implements Factory<String> {
    ...
    private static final class InstanceHolder {
        private static final SendLogsFinishedViewModel_HiltModules_KeyModule_ProvideFactory INSTANCE = new SendLogsFinishedViewModel_HiltModules_KeyModule_ProvideFactory();
