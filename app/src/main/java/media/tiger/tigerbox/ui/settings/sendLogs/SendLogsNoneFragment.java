...
public final class SendLogsNoneFragment extends Hilt_SendLogsNoneFragment {
    ...
    public SendLogsNoneFragment() {
        final SendLogsNoneFragment sendLogsNoneFragment = this;
        this.binding$delegate = AutoClearedValueKt.autoCleared(sendLogsNoneFragment);
        final Function0<Fragment> function0 = new Function0<Fragment>() { // from class: media.tiger.tigerbox.ui.settings.sendLogs.SendLogsNoneFragment$special$$inlined$viewModels$default$1
            {
                super(0);
            }
        ...
        this.viewModel$delegate = FragmentViewModelLazyKt.createViewModelLazy(sendLogsNoneFragment, Reflection.getOrCreateKotlinClass(SendLogsNoneViewModel.class), new Function0<ViewModelStore>() { // from class: media.tiger.tigerbox.ui.settings.sendLogs.SendLogsNoneFragment$special$$inlined$viewModels$default$2
            {
                super(0);
            }
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: media.tiger.tigerbox.ui.settings.sendLogs.SendLogsNoneFragment$special$$inlined$viewModels$default$3
            ...
            public final ViewModelProvider.Factory invoke() {
                ...
                if (defaultViewModelProviderFactory == null) {
                    defaultViewModelProviderFactory = sendLogsNoneFragment.getDefaultViewModelProviderFactory();
                }
    ...
    private final FragmentSendLogsNoneBinding getBinding() {
        return (FragmentSendLogsNoneBinding) this.binding$delegate.getValue((Fragment) this, $$delegatedProperties[0]);
    }

    private final void setBinding(FragmentSendLogsNoneBinding fragmentSendLogsNoneBinding) {
        this.binding$delegate.setValue2((Fragment) this, $$delegatedProperties[0], (KProperty<?>) fragmentSendLogsNoneBinding);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        FragmentSendLogsNoneBinding inflate = FragmentSendLogsNoneBinding.inflate(inflater, viewGroup, false);
        Intrinsics.checkNotNullExpressionValue(inflate, "inflate(inflater, container, false)");
        setBinding(inflate);
        getBinding().setCloseHandler(new UnTypedBindingClickListener() { // from class: media.tiger.tigerbox.ui.settings.sendLogs.SendLogsNoneFragment$onCreateView$1
            @Override // media.tiger.tigerbox.ui.binding.UnTypedBindingClickListener
            public void onClick() {
                SendLogsNoneFragment.this.closeSafely();
            }
        });
