...
public final class WildCardReAssigningStep1Fragment extends Hilt_WildCardReAssigningStep1Fragment {
    ...
    public WildCardReAssigningStep1Fragment() {
        final WildCardReAssigningStep1Fragment wildCardReAssigningStep1Fragment = this;
        this.binding$delegate = AutoClearedValueKt.autoCleared(wildCardReAssigningStep1Fragment);
        final Function0<Fragment> function0 = new Function0<Fragment>() { // from class: media.tiger.tigerbox.ui.settings.wildcardreassigning.WildCardReAssigningStep1Fragment$special$$inlined$viewModels$default$1
            {
                super(0);
            }
        ...
        this.step1ViewModel$delegate = FragmentViewModelLazyKt.createViewModelLazy(wildCardReAssigningStep1Fragment, Reflection.getOrCreateKotlinClass(WildCardReAssigningStep1ViewModel.class), new Function0<ViewModelStore>() { // from class: media.tiger.tigerbox.ui.settings.wildcardreassigning.WildCardReAssigningStep1Fragment$special$$inlined$viewModels$default$2
            {
                super(0);
            }
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: media.tiger.tigerbox.ui.settings.wildcardreassigning.WildCardReAssigningStep1Fragment$special$$inlined$viewModels$default$3
            ...
            public final ViewModelProvider.Factory invoke() {
                ...
                if (defaultViewModelProviderFactory == null) {
                    defaultViewModelProviderFactory = wildCardReAssigningStep1Fragment.getDefaultViewModelProviderFactory();
                }
    ...
    private final FragmentWildcardReassigningStep1Binding getBinding() {
        return (FragmentWildcardReassigningStep1Binding) this.binding$delegate.getValue((Fragment) this, $$delegatedProperties[0]);
    }

    private final void setBinding(FragmentWildcardReassigningStep1Binding fragmentWildcardReassigningStep1Binding) {
        this.binding$delegate.setValue2((Fragment) this, $$delegatedProperties[0], (KProperty<?>) fragmentWildcardReassigningStep1Binding);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        FragmentWildcardReassigningStep1Binding inflate = FragmentWildcardReassigningStep1Binding.inflate(inflater, viewGroup, false);
        Intrinsics.checkNotNullExpressionValue(inflate, "inflate(inflater, container, false)");
        setBinding(inflate);
        getBinding().wildcardReassigningStep1CancelButton.setOnClickListener(new View.OnClickListener() { // from class: media.tiger.tigerbox.ui.settings.wildcardreassigning.WildCardReAssigningStep1Fragment$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                WildCardReAssigningStep1Fragment.m2024onCreateView$lambda0(WildCardReAssigningStep1Fragment.this, view);
            }
        });
    ...
    public static final void m2024onCreateView$lambda0(WildCardReAssigningStep1Fragment this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.getStep1ViewModel().cancelWildcardReassign();
    }
